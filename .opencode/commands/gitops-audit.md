...
**Purpose:** Audit GitOps, CI/CD, IaC, observability, and platform engineering maturity. Evaluate pipelines, deployment manifests, supply chain controls. Produce a maturity scorecard and prioritized improvement roadmap. Think like a platform engineering and DevSecOps specialist.
...
**Optional inputs:** Focus areas (e.g., supply chain only, observability only).

**Workflow:**
1. Locate CI/CD configs (.github, .gitlab, Jenkinsfile, etc.).
2. Locate deployment manifests (Argo CD, Flux, Helm, Kustomize).
3. Locate IaC (Terraform, Pulumi, CloudFormation).
