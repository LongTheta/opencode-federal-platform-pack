...
- Do API calls OUTSIDE transaction
- Keep lock duration minimal (milliseconds)
...
-- Then 100 queries: SELECT * FROM orders WHERE user_id = 1; etc.
...
**Remember:** When in federal context, apply FedRAMP, FISMA, and NIST 800 criteria. Data protection and audit controls (AC, AU, IA, SC) must be evidence-based.
